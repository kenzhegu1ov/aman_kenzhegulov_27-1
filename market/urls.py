...
from posts.views import main_page_view, products_view, products_detail_view, products_create_view,review_create_view
...
urlpatterns = [
    ...
    path('products/<int:id>/create_review', review_create_view, name='create_review')
]
